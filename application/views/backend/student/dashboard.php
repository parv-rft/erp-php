 ...
 <div class="row">
                ...
                <!-- .row -->
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="white-box">
                            <h3 class="box-title" style="font-size: 1.5em; color: #7F7F7F;"><?php echo get_phrase('Recent_Attendance');?></h3>
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        while ($current_dt <= $end_dt):
                                            ...
                                            $status = isset($attendance_data[$full_date]) ? $attendance_data[$full_date] : null; // Get status for this date
                                        ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php elseif ($status !== null): // Other statuses if applicable ?>
                                                    <span class="label label-info"><?php echo get_phrase('status_') . $status;?></span>
                                                <?php else: // No record found for this day ?>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php 
                                                // Assuming role 1=Class Teacher, 2=Subject Teacher (based on old code). Add more if needed.
                                                if($row['role'] == 1) echo get_phrase('class_teacher');
                                                elseif($row['role'] == 2) echo get_phrase('subject_teacher');
                                                // You might want to add a default case or fetch role names from a different table if roles are more complex
                                                else echo get_phrase('teacher'); 
                                                ?>
                                            </td>
                                            <td><?php echo $row['email'] ? $row['email'] : '-';?></td>
                                            <td><?php echo $row['phone'] ? $row['phone'] : '-';?></td>
                                            <td><?php echo $row['sex'] ? $row['sex'] : '-'; // Use 'sex' column as in DB ?></td>
                                        </tr>
                                        <?php endforeach; ?>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="white-box">
                            <h3 class="box-title" style="font-size: 1.5em; color: #7F7F7F;"><?php echo get_phrase('Recent_Payment_History');?></h3>
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                    ...
                                    <?php 
                                        $count = 1;
                                        $currency_symbol = $this->db->get_where('settings', array('type' => 'currency'))->row()->description; // Get currency symbol
